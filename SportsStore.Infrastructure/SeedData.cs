...
public static class SeedData
{
    public static void EnsurePopulated(IServiceProvider services)
    {
        ...
        try
        {
            ...
            // Don't attempt relational migrations when using the InMemory provider.
        ...
        {
            // If the database cannot be reached (missing instance, permissions, etc.), log and continue so app doesn't crash on startup.
            logger?.LogError(ex, "An error occurred while migrating or seeding the database. Seeding skipped.");
        }
    }
}